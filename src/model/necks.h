 ...
 * scales. Each output is [1, H_i, W_i, d_model] in NHWC format. All
 * downstream consumers (seg_head, mask decoder, geometry fusion) now
 * consume NHWC directly, so no bridge permute is needed.
 *
