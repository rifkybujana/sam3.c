...
struct sam3_image_model {
	...
	/*
	 * Multi-scale backbone features for FPN pixel decoders. The
	 * NCHW snapshots feed the mask decoder path (Task 10 still).
	 * The NHWC snapshots feed the NHWC seg_head after Task 9.
	 */
